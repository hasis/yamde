...
var Yamde = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: classes.yamde },
        ...
        react_1.default.createElement("div", { className: classes.contentArea }, !isPreviewMode ? (react_1.default.createElement("textarea", { rows: 12, name: "yamdeContent", value: value, onChange: function (e) { return handleChange(e); }, ref: textEditor })) : (react_1.default.createElement("div", { className: classes.preview, dangerouslySetInnerHTML: { __html: htmlPreview } }))),
